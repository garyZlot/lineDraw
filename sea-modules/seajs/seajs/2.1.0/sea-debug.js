...
Module.prototype.load = function() {
  ...
  // Initialize sea-modules and register waitings
  for (var i = 0; i < len; i++) {
    m = Module.get(uris[i])
...
Module.prototype.onload = function() {
  ...
  // Notify waiting sea-modules to fire onload
...
Module.define = function (id, deps, factory) {
  ...
  // Try to derive uri in IE6-9 for anonymous sea-modules
...
// Load preload sea-modules before all other sea-modules
Module.preload = function(callback) {
  ...
  if (len) {
    Module.use(preloadMods, function() {
      // Remove the loaded preload sea-modules
      preloadMods.splice(0, len)

      // Allow preload sea-modules to add new preload sea-modules
...
function save(uri, meta) {
  ...
  // Do NOT override already saved sea-modules
...
// Modules that are needed to load before all other sea-modules
